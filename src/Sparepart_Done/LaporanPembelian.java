...
public class LaporanPembelian extends javax.swing.JFrame {
    ...
    public void showData() {
        ...
        try {
            ...
            query = "SELECT T_Det_Sparepart_Masuk.Id_Sparepart, T_Sparepart.Nama_Sparepart, SUM(T_Det_Sparepart_Masuk.Jmlh_Masuk) AS JmlhMasuk,SUM(T_Det_Sparepart_Masuk.Total_Per_Detail) AS TotalPerBarang "
    ...
    public void cariData() {
        ...
        try {
            ...
            query = "SELECT T_Det_Sparepart_Masuk.Id_Sparepart, T_Sparepart.Nama_Sparepart, SUM(T_Det_Sparepart_Masuk.Jmlh_Masuk) AS JmlhMasuk,SUM(T_Det_Sparepart_Masuk.Total_Per_Detail) AS TotalPerBarang "
                    ...
                    + "WHERE T_Sparepart.Id_Sparepart = T_Det_Sparepart_Masuk.Id_Sparepart AND T_Faktur_Sparepart_Masuk.Id_Sprt_Masuk = T_Det_Sparepart_Masuk.Id_Sprt_Masuk AND T_Faktur_Sparepart_Masuk.Tanggal BETWEEN '" + tglAwal + "' AND '" + tglAkhir + "' "
                    + "GROUP BY T_Det_Sparepart_Masuk.Id_Sparepart";
            ResultSet rs = stmt.executeQuery(query);
            int no = 1;
            while (rs.next()) {
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Sparepart_Done/Laporan/Laporan Pembelian");
