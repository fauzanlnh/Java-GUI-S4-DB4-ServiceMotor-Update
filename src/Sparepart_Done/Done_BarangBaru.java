 ...
 * @author Fauzanlh
 */
public class Done_BarangBaru extends javax.swing.JFrame {

    /**
     * Creates new form Done_BarangBaru
     */
    Connection koneksi;

    public Done_BarangBaru() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Done_BarangBaru.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Done_BarangBaru().setVisible(true);
            }
        });
    }
