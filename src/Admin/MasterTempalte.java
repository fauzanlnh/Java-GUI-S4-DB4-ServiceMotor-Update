 ...
 * @author Fauzanlh
 */
public class MasterTempalte extends javax.swing.JFrame {
    ...
    public void FormDefault() {
        ...
        btnClearPegawai.setEnabled(true);
    ...
    public void SetForm() {
        if (!txtUsername.getText().equals("") || !txtPassword.getText().equals("")) {
            ...
            btnClearPegawai.setEnabled(false);
            btnSimpan.setEnabled(false);
        } else if (!txtNama.getText().equals("") || !txtAlamat.getText().equals("") || !txtNoTelp.getText().equals("") || !txtUsernameBaru.getText().equals("") || !txtPassword1.getText().equals("")) {
            txtUsername.setEnabled(false);
            txtPassword.setEnabled(false);
            btnClearPass.setEnabled(false);
    ...
    public void UbahPassword() {
        ...
        try {
            ...
            if (!User.equals("") && !Pass.equals("")) {
                String SqlUbahPassword = "UPDATE T_Login SET Password = '" + Pass + "' WHERE Username = '" + User + "'";
    ...
    private void initComponents() {
        ...
        lblNoPol8.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        lblNoPol8.setForeground(new java.awt.Color(51, 51, 51));
        lblNoPol8.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        lblNoPol8.setText("    < Home");
        ...
        btnHomeLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, btnHomeLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(lblNoPol8, javax.swing.GroupLayout.DEFAULT_SIZE, 53, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        FormUbahLayout.setHorizontalGroup(
            ...
            .addGroup(FormUbahLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(FormUbahLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(FormUbahLayout.createSequentialGroup()
        ...
        Form1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Tambah Pegawai", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 16), new java.awt.Color(51, 51, 51))); // NOI18N
        ...
        txtUsernameBaru.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                txtUsernameBaruKeyReleased(evt);
            }
        });
    ...
    private void txtUsernameBaruKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtUsernameBaruKeyReleased
        SetForm();
    }//GEN-LAST:event_txtUsernameBaruKeyReleased
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MasterTempalte.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MasterTempalte().setVisible(true);
            }
        });
    }
