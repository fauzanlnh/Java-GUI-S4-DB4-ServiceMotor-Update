...
public class BarangMasuk extends javax.swing.JFrame {
    ...
    public void cariData() {
        ...
        try {
            ...
            query = "SELECT * FROM T_Sparepart,T_Jenis WHERE T_Jenis.Id_Jenis = T_Sparepart.Id_Jenis "
    ...
    public void SimpanFaktur() {
        ...
        try {
            Statement stmt = koneksi.createStatement();
            //QUERY 1
            String InsertFaktur = "INSERT INTO T_Faktur_Sparepart_Masuk (Id_Sprt_Masuk, Tanggal) VALUES ('" + KdFaktur + "', '" + tanggal + "')";
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Sparepart/Barang Masuk");
