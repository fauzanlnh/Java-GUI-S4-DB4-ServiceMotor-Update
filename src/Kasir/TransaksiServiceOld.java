 ...
 * @author Fauzanlh
 */
public class TransaksiServiceOld extends javax.swing.JFrame {

    /**
     * Creates new form TransaksiService
     */
    Connection koneksi;
    String KdJenisMotor, KdTeknisi, IdPegawai;

    public TransaksiServiceOld() {
        initComponents();
    ...
    public void getListTeknisi() {
        ...
        cmbTeknisi.addItem("-");
        try {
            String SelectKD = "SELECT * FROM T_Pegawai WHERE Jabatan = 'TEKNISI' AND Nama_Pegawai != 'TEKNISI'";
            Statement st = koneksi.createStatement();
            ResultSet rs = st.executeQuery(SelectKD);
            while (rs.next()) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TransaksiServiceOld.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TransaksiServiceOld().setVisible(true);
            }
        });
    }
