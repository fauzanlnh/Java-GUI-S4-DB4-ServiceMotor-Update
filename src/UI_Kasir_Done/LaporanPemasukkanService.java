 ...
 * @author Fauzanlh
 */
public class LaporanPemasukkanService extends javax.swing.JFrame {

    /**
     * Creates new form LaporanPemasukkanService
     */
    public LaporanPemasukkanService() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel7.setText("UI_Kasir_Done/Laporan/Laporan Pemasukan");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LaporanPemasukkanService.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LaporanPemasukkanService().setVisible(true);
            }
        });
    }
