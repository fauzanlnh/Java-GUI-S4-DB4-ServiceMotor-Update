 ...
 */
public class LaporanChartMelakukanService extends javax.swing.JFrame {

    /**
     * Creates new form LaporanMelakukanService
     */
    public LaporanChartMelakukanService() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel7.setText("UI_Kasir_Done/Laporan/Chart Service");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LaporanChartMelakukanService.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LaporanChartMelakukanService().setVisible(true);
            }
        });
    }
