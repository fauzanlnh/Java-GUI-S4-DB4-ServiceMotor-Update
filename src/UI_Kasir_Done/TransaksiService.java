...
public class TransaksiService extends javax.swing.JFrame {
    ...
    public void InsertDataDetFaktur() {
        ...
        int BerhasilDetSparepart = 0, BerhasilDetService = 0;
        ...
        if (cmbTeknisi.getSelectedItem().equals("-")) {
            ...
            cmbService.requestFocus();
        } else if (txtTotalService.getText().equals("0") && (tSparepart.getRowCount() > 0 || tService.getRowCount() > 0)) {
    ...
    private void initComponents() {
        ...
        btnCariFaktur.setBackground(new java.awt.Color(240, 240, 240));
        btnCariFaktur.setFont(new java.awt.Font("Calibri", 0, 14)); // NOI18N
        btnCariFaktur.setForeground(new java.awt.Color(51, 51, 51));
        btnCariFaktur.setText("Cari");
        btnCariFaktur.setBorder(null);
                        ...
                        .addGroup(mainPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(mainPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(mainPanel1Layout.createSequentialGroup()
                                    ...
                                    .addComponent(btnCariFaktur, javax.swing.GroupLayout.PREFERRED_SIZE, 104, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        mainPanel1Layout.setVerticalGroup(
            ...
            .addGroup(mainPanel1Layout.createSequentialGroup()
                ...
                .addGroup(mainPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(btnCariFaktur, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
